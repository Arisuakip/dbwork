...
public class moneyAddServlet extends ViewBaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            String m_datestr = request.getParameter("m_date");
            ...
            moneyDAO.addMoney(new Money(0,m_action,m_count,m_date,m_userid,m_username));
